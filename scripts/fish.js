...
const putMonologue = (fish) => {
    if (fish === `bongli`) {
        ...
        return `wha- partack!?!??!?<br>were there [REDACTED] under the sea???`;
    } else if (fish === `bluestrings`) {
        return `for some reason.. this reminds me of..<br>bluestrings......`;
    } else if (fish === `jelly`) {
        return `this jellyfish reminds me of..<br>a certain jellyman..`;
    } else if (fish === `truilt`) {
...
const fishObjects = [
    {
        ...
        link: `https://x.com/miermiermierlol`,
        name: `@mier`
    },
    {
        stars: `★★★★★`,
        ...
        link: `https://www.instagram.com/23.bleu/`,
        name: `@abri`,
    },
    {
        stars: `★★★★☆`,
    ...
    },
    {
        ...
        link: `https://x.com/GoodbyeCricket`,
        name: `@genki`,
    },
    {
        stars: `★★★★☆`,
    ...
    },
    {
        ...
        link: `https://www.instagram.com/yooyobu/`,
        name: `@yobu`,
    },
    {
        stars: `★★★★☆`,
        ...
        link: `https://www.instagram.com/ka__ags/`,
        name: `@kags`,
    },
    {
        stars: `★★★★☆`,
        ...
        desc: `Giant isopods are deep-sea crustaceans that can grow up to 50 cm (20 inches) long (unlike Jett in real life), making them one of the largest isopods in existence. They are scavengers that feed on dead whales, fish, and other organic material that falls to the ocean floor. Due to their slow metabolism, they can survive for long periods without food.<br><br>Fun Fact: A giant isopod at a Japanese aquarium went for five years without eating, surviving entirely on stored energy.`,
        link: `https://x.com/Jett1586`,
        name: `@jett`,
    },
    {
        stars: `★★★☆☆`,
